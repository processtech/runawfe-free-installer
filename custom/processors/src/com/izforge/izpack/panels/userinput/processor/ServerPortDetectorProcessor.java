 ...
 * <p>
 * Attached to host field this processor attempts to connect to common HTTP ports (@code PORTS) on the specified host via TCP connect. The first open
 * port is returned and written to the variable specified by {@code toVariable}
 * <p>
