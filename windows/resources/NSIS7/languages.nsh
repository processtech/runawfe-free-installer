...
LangString TEXT_PROJECT_SITE ${LANG_ENGLISH} "Project site: http://wf.runa.ru"
LangString TEXT_PROJECT_SITE ${LANG_RUSSIAN} "Сайт проекта: http://wf.runa.ru/rus"
LangString LINK_PROJECT_SITE ${LANG_ENGLISH} "http://wf.runa.ru"
LangString LINK_PROJECT_SITE ${LANG_RUSSIAN} "http://wf.runa.ru/rus"
